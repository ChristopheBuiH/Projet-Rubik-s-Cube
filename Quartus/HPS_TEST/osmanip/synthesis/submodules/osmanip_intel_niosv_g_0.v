...
`timescale 1 ps / 1 ps
module osmanip_intel_niosv_g_0 (
	...
	osmanip_intel_niosv_g_0_hart #(
		.RESET_VECTOR             (32'b00000000000000000000000000000000),
		.DBG_EXPN_VECTOR          (32'b00000001000000000000000000000000),
		...
		.DBG_DATA_S_BASE          (32'b00000001000000000000000000000000),
		.TIMER_MSIP_DATA_S_BASE   (32'b00000001000000010000000001000000),
		.DTCM1_SIZE               (0),
	...
	osmanip_intel_niosv_g_0_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	osmanip_intel_niosv_g_0_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	osmanip_intel_niosv_g_0_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
