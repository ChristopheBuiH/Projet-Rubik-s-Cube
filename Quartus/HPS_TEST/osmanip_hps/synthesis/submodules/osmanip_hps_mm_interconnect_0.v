// osmanip_hps_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module osmanip_hps_mm_interconnect_0 (
		...
		input  wire        Osmanip_0_reset_sink_reset_bridge_in_reset_reset,                    //                    Osmanip_0_reset_sink_reset_bridge_in_reset.reset
	...
	wire   [20:0] osmanip_0_s1_agent_m0_address;                            // Osmanip_0_s1_agent:m0_address -> Osmanip_0_s1_translator:uav_address
	...
	wire   [85:0] osmanip_0_s1_agent_rf_source_data;                        // Osmanip_0_s1_agent:rf_source_data -> Osmanip_0_s1_agent_rsp_fifo:in_data
	...
	wire   [85:0] osmanip_0_s1_agent_rsp_fifo_out_data;                     // Osmanip_0_s1_agent_rsp_fifo:out_data -> Osmanip_0_s1_agent:rf_sink_data
	...
	wire          osmanip_0_s1_agent_rp_valid;                              // Osmanip_0_s1_agent:rp_valid -> router_002:sink_valid
	wire   [84:0] osmanip_0_s1_agent_rp_data;                               // Osmanip_0_s1_agent:rp_data -> router_002:sink_data
	wire          osmanip_0_s1_agent_rp_ready;                              // router_002:sink_ready -> Osmanip_0_s1_agent:rp_ready
	wire          osmanip_0_s1_agent_rp_startofpacket;                      // Osmanip_0_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          osmanip_0_s1_agent_rp_endofpacket;                        // Osmanip_0_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire          onchip_memory2_0_s1_agent_rp_valid;                       // onchip_memory2_0_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] onchip_memory2_0_s1_agent_rp_data;                        // onchip_memory2_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire   [84:0] osmanip_0_s1_burst_adapter_source0_data;                  // Osmanip_0_s1_burst_adapter:source0_data -> Osmanip_0_s1_agent:cp_data
	wire          osmanip_0_s1_burst_adapter_source0_ready;                 // Osmanip_0_s1_agent:cp_ready -> Osmanip_0_s1_burst_adapter:source0_ready
	wire    [1:0] osmanip_0_s1_burst_adapter_source0_channel;               // Osmanip_0_s1_burst_adapter:source0_channel -> Osmanip_0_s1_agent:cp_channel
	...
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // onchip_memory2_0_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> onchip_memory2_0_s1_burst_adapter:sink0_channel
	...
	wire          router_002_src_valid;                                     // router_002:src_valid -> Osmanip_0_s1_rsp_width_adapter:in_valid
	wire   [84:0] router_002_src_data;                                      // router_002:src_data -> Osmanip_0_s1_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                     // Osmanip_0_s1_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                   // router_002:src_channel -> Osmanip_0_s1_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                             // router_002:src_startofpacket -> Osmanip_0_s1_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                               // router_002:src_endofpacket -> Osmanip_0_s1_rsp_width_adapter:in_endofpacket
	wire          osmanip_0_s1_rsp_width_adapter_src_valid;                 // Osmanip_0_s1_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [111:0] osmanip_0_s1_rsp_width_adapter_src_data;                  // Osmanip_0_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          osmanip_0_s1_rsp_width_adapter_src_ready;                 // rsp_demux:sink_ready -> Osmanip_0_s1_rsp_width_adapter:out_ready
	wire    [1:0] osmanip_0_s1_rsp_width_adapter_src_channel;               // Osmanip_0_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          osmanip_0_s1_rsp_width_adapter_src_startofpacket;         // Osmanip_0_s1_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          osmanip_0_s1_rsp_width_adapter_src_endofpacket;           // Osmanip_0_s1_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> Osmanip_0_s1_cmd_width_adapter:in_valid
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> Osmanip_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                        // Osmanip_0_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> Osmanip_0_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> Osmanip_0_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> Osmanip_0_s1_cmd_width_adapter:in_endofpacket
	...
	wire   [84:0] osmanip_0_s1_cmd_width_adapter_src_data;                  // Osmanip_0_s1_cmd_width_adapter:out_data -> Osmanip_0_s1_burst_adapter:sink0_data
	...
	wire    [1:0] osmanip_0_s1_cmd_width_adapter_src_channel;               // Osmanip_0_s1_cmd_width_adapter:out_channel -> Osmanip_0_s1_burst_adapter:sink0_channel
	...
	wire          osmanip_0_s1_agent_rdata_fifo_out_valid;                  // Osmanip_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire    [9:0] osmanip_0_s1_agent_rdata_fifo_out_data;                   // Osmanip_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          osmanip_0_s1_agent_rdata_fifo_out_ready;                  // avalon_st_adapter:in_0_ready -> Osmanip_0_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> Osmanip_0_s1_agent:rdata_fifo_sink_valid
	wire    [9:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> Osmanip_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // Osmanip_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> Osmanip_0_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (Osmanip_0_reset_sink_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (Osmanip_0_reset_sink_reset_bridge_in_reset_reset), //       clk_reset.reset
	...
	osmanip_hps_mm_interconnect_0_router router (
	...
	osmanip_hps_mm_interconnect_0_router router_001 (
	...
	osmanip_hps_mm_interconnect_0_router_002 router_002 (
	...
	osmanip_hps_mm_interconnect_0_router_003 router_003 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (Osmanip_0_reset_sink_reset_bridge_in_reset_reset), // cr0_reset.reset
	...
	osmanip_hps_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	osmanip_hps_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	osmanip_hps_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (Osmanip_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	osmanip_hps_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (Osmanip_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	osmanip_hps_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (Osmanip_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	osmanip_hps_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (Osmanip_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	osmanip_hps_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	osmanip_hps_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	osmanip_hps_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (10),
		.inUsePackets    (0),
		.inDataWidth     (10),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (Osmanip_0_reset_sink_reset_bridge_in_reset_reset), // in_rst_0.reset
	...
	osmanip_hps_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
