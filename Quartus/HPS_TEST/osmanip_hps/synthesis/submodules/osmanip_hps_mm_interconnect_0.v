...
module osmanip_hps_mm_interconnect_0 (
	...
	wire          osmanip_0_s1_agent_rp_valid;                              // Osmanip_0_s1_agent:rp_valid -> router_003:sink_valid
	wire   [84:0] osmanip_0_s1_agent_rp_data;                               // Osmanip_0_s1_agent:rp_data -> router_003:sink_data
	wire          osmanip_0_s1_agent_rp_ready;                              // router_003:sink_ready -> Osmanip_0_s1_agent:rp_ready
	wire          osmanip_0_s1_agent_rp_startofpacket;                      // Osmanip_0_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          osmanip_0_s1_agent_rp_endofpacket;                        // Osmanip_0_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          router_003_src_valid;                                     // router_003:src_valid -> Osmanip_0_s1_rsp_width_adapter:in_valid
	wire   [84:0] router_003_src_data;                                      // router_003:src_data -> Osmanip_0_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                     // Osmanip_0_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                   // router_003:src_channel -> Osmanip_0_s1_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                             // router_003:src_startofpacket -> Osmanip_0_s1_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                               // router_003:src_endofpacket -> Osmanip_0_s1_rsp_width_adapter:in_endofpacket
	wire          osmanip_0_s1_rsp_width_adapter_src_valid;                 // Osmanip_0_s1_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [111:0] osmanip_0_s1_rsp_width_adapter_src_data;                  // Osmanip_0_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          osmanip_0_s1_rsp_width_adapter_src_ready;                 // rsp_demux_001:sink_ready -> Osmanip_0_s1_rsp_width_adapter:out_ready
	wire    [1:0] osmanip_0_s1_rsp_width_adapter_src_channel;               // Osmanip_0_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> Osmanip_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                    // Osmanip_0_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> Osmanip_0_s1_cmd_width_adapter:in_channel
